  ...
  <div class="min-h-screen bg-slate-50">
    <div class="mx-auto flex w-full max-w-screen-md flex-col gap-8 px-5 pb-20 pt-6">
      <section class="flex flex-col gap-2">
        <span class="text-[11px] font-black uppercase tracking-[0.18em] text-blue-600">Panel admin</span>
        <h1 class="text-2xl font-black tracking-tight text-blue-950">Crear categoría</h1>
      ...
      <form @submit.prevent="onSubmit" class="rounded-[34px] border border-slate-100 bg-white p-5 shadow-[0_16px_40px_rgba(15,23,42,0.06)]">
        <div class="flex flex-col gap-6">
          <div class="flex flex-col gap-2">
            ...
            <input v-model="name" type="text" placeholder="Ej: Reels, Cañas, Señuelos..." class="h-13 rounded-2xl border border-slate-200 bg-white px-4 text-sm font-semibold text-blue-950 outline-none transition placeholder:text-slate-400 focus:border-blue-500">
          </div>

          <div class="flex flex-col gap-2">
            <label class="text-sm font-black text-blue-900">Sección</label>

            <select v-model="sectionId" class="h-13 rounded-2xl border border-slate-200 bg-white px-4 text-sm font-semibold text-blue-950 outline-none transition focus:border-blue-500">
