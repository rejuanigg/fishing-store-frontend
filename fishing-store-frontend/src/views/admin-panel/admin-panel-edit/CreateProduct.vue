...
<template>
  ...
  <div class="bg-red-50 w-1/2 h-[calc(100vh-5rem)] flex justify-center items-center">
...
<!-- v-if="previewProduct" :product="previewProduct" -->
  ...
  <div class="bg-red-100 w-1/2 h-svh flex justify-center items-center flex-col gap-10">
