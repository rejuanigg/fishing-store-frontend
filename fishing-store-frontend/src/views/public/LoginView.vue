    ...
    <main class="relative z-10 flex min-h-[100dvh] w-full items-center justify-center px-5 py-10 sm:px-6 lg:px-10">
      <div class="grid w-full max-w-5xl gap-6 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
        <section class="hidden rounded-[34px] border border-white/70 bg-white/65 p-7 shadow-[0_18px_50px_rgba(15,23,42,0.08)] backdrop-blur-xl lg:block">
          ...
          <h1 class="mt-8 max-w-md text-5xl font-black leading-[1.05] tracking-tight text-blue-950">
          ...
          <div class="mt-10 grid gap-3">
            <div class="rounded-[28px] border border-blue-100 bg-white/80 p-5 shadow-[0_14px_35px_rgba(15,23,42,0.05)]">
              <p class="text-sm font-black text-blue-950">Seguimiento de pedidos</p>
            ...
            <div class="rounded-[28px] border border-cyan-100 bg-white/80 p-5 shadow-[0_14px_35px_rgba(15,23,42,0.05)]">
              <p class="text-sm font-black text-blue-950">Compra más simple</p>
        ...
        <section class="mx-auto w-full max-w-md">
          <div class="mb-6 text-center lg:hidden">
            ...
            <h1 class="mt-2 text-3xl font-black tracking-tight text-blue-950">Iniciá sesión</h1>
          ...
          <div class="rounded-[34px] border border-white/80 bg-white/90 p-6 shadow-[0_20px_55px_rgba(15,23,42,0.10)] backdrop-blur-xl sm:p-8">
            <div class="hidden lg:block">
              <p class="text-sm font-black uppercase tracking-[0.16em] text-blue-700">Ingresar</p>
              <h2 class="mt-3 text-3xl font-black tracking-tight text-blue-950">Bienvenido de vuelta</h2>
            ...
            <form class="mt-6 flex w-full flex-col gap-5 lg:mt-8" @submit.prevent="onSubmit" id="login">
              <div class="flex flex-col gap-2">
                <label class="text-sm font-black text-blue-950" for="login-email">Email</label>
                ...
                <input
                  ...
                  class="min-h-[54px] rounded-2xl border border-slate-200 bg-slate-50/80 px-4 text-sm font-semibold text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-blue-400 focus:bg-white focus:ring-4 focus:ring-blue-100"
                >
              </div>

              <div class="flex flex-col gap-2">
                <label class="text-sm font-black text-blue-950" for="login-password">Contraseña</label>
              ...
              <button
                type="submit"
                :disabled="!canSubmit"
                class="mt-2 min-h-[56px] rounded-2xl bg-blue-600 px-5 text-base font-black text-white shadow-[0_14px_32px_oklch(0.424 0.199 265.638)] transition hover:bg-blue-700 active:scale-[0.98] disabled:bg-slate-200 disabled:text-slate-400 disabled:shadow-none disabled:active:scale-100"
              >
            ...
            <div class="mt-6 rounded-3xl border border-blue-100 bg-blue-50/70 px-5 py-4 text-center">
              <span class="text-sm font-semibold text-slate-600">
                ¿No tenés una cuenta?
                <RouterLink class="font-black text-blue-700" to="/register">Registrate</RouterLink>
              </span>
            </div>
          </div>
        </section>
